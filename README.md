...
![Answer reveal — a map of Japan shows where the prefecture sits](screenshots/answer-reveal.png)
...
| Title | Finish |
| --- | --- |
| ![Title menu](screenshots/title.png) | ![Congratulations screen](screenshots/congrats.png) |
